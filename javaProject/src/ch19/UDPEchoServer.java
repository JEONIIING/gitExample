...
public class UDPEchoServer {
	...
	public static void main(String[] args) throws Exception{
		new UDPEchoServer(3000); //서버츨 포트번호 3000으로 세팅
