...
public class KeyMouseExam extends JApplet implements MouseListener, MouseMotionListener, KeyListener{
	...
	private boolean flag=false; //이미지가 처음 실행할 땐 안보이게 처리하기 위해
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_UP: //위쪽 키를 누르면
			y = Math.max(0, y-5); break; //프레임을 밖으로 빠져나가지 못하게 박스안에 고정시키는 것.
	...
	//컴포넌트상에서 마우스 버튼을 클릭(마우스를 눌렀다가 놓을때) 했을때에 호출
	@Override
