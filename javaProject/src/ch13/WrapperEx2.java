...
public class WrapperEx2 {
	public static void main(String[] args) {
		...
		System.out.println(Integer.toString(200)); //정수를 문자열로 반환
		System.out.println(Integer.toBinaryString(200)); //정수 200을 2진수 문자열로
		...
		System.out.println(Boolean.parseBoolean("false")); //"false"문자열을 boolean형 false로 변
	}
}
